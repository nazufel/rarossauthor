export default function Home() {
  ...
  return (
    <div className="h-screen w-screen">
      <div className="container flex justify-center pt-10 flex-row items-center w-screen mx-auto">
      ...
      {/* intro and cta text */}
      <div className="container mt-10 text-center text-xl mx-auto md:px-100">
